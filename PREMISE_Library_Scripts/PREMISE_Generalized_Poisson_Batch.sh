...
# to run: qsub PREMISE_Generalized_Poisson_Batch.sh 
...
python PREMISE_Library_Scripts/filter_on_reads.py $currentDirectory
python PREMISE_Library_Scripts/join_counts_to_input.py $currentDirectory $inputCounts
...
for file in Sample_Counts_Merged/*;
    ...
    python PREMISE_Library_Scripts/round_normalized_data.py $normalizedData
