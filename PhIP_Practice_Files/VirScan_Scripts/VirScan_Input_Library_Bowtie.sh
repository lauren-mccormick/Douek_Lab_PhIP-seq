...
# to run: qsub VirScan_Scripts/VirScan_Input_Library_Bowtie.sh Demultiplexed_Data VirScan_Dereplicated_bowtie_index/VIR3_dereplicated
...
for dir in $demultiplexedFolder/Input_Library/*;
    ...
    echo -e "id\t"$d > Input_Library_Counts/$countFile
